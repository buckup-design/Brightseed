...
*Internal. This is the doc for you, not Anna. It names people and the real setup.*

The goal: Anna can explore, prototype, and review Hummingbird screens without breaking production or eroding token discipline. The system carries the polish; the workflow keeps the two of you from stepping on each other.
...
The principle underneath: **Anna diverges, you converge.** She moves fast and loose on purpose; you decide what's load-bearing enough to enter the system. Don't try to make her work inside components, that's not her mode, and the system exists precisely so it doesn't have to be.
