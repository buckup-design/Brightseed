 ...
 *
 * Color tokens (via the component tier, --c-status-badge-*):
 *   Neutral surface → --ds-color-surface-alt
 *   Neutral text    → --ds-color-text-subtle
 *   Neutral dot     → --ds-color-icon-subtle
 *   Success surface → --ds-color-surface-success
 *   Success text    → --ds-color-text-success
 *   Success dot     → --ds-color-icon-success
 */
