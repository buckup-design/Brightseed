...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "border-b border-[var(--c-accordion-border-subtle)] last:border-b-0",
        className
      )}
      {...props}
    />
    ...
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          ...
          "focus-visible:ring-[2px] focus-visible:ring-[var(--c-accordion-border-focus)]",
      ...
      >
        {children}
        <ChevronDownIcon className="pointer-events-none size-4 shrink-0 translate-y-0.5 text-[var(--c-accordion-icon-subtle)] transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
