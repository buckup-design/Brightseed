...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-[var(--c-sidebar-shape-radius-md)] px-2 text-[var(--c-sidebar-text-default)] ring-[var(--c-sidebar-border-focus)] outline-hidden hover:bg-[var(--c-sidebar-surface-alt)] hover:text-[var(--c-sidebar-text-default)] focus-visible:ring-2 active:bg-[var(--c-sidebar-surface-alt)] active:text-[var(--c-sidebar-text-default)] disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-[var(--c-sidebar-text-default)]",
