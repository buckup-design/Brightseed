  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=unchecked]:bg-[var(--ds-switch-border-default)]",
        "data-[state=checked]:bg-[var(--ds-switch-action-primary)]",
        "hover:data-[state=checked]:bg-[var(--ds-switch-action-primary-hover)]",
        // Focus
        "outline-none",
        "focus-visible:ring-[3px] focus-visible:ring-[var(--ds-switch-border-focus)]/50",
        "focus-visible:border-[var(--ds-switch-border-focus)]",
        // Disabled
        "disabled:cursor-not-allowed disabled:opacity-[var(--ds-switch-disabled-text-opacity)]",
        className
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "bg-[var(--ds-switch-surface-default)]",
