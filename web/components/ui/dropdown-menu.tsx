    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-[var(--ds-dropdown-menu-shape-radius-md)]",
          "border border-[var(--ds-dropdown-menu-border-default)]",
          "bg-[var(--ds-dropdown-menu-surface-default)] text-[var(--ds-dropdown-menu-text-default)]",
          "p-1 shadow-[var(--ds-dropdown-menu-shadow-md)]",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "rounded-[var(--ds-dropdown-menu-shape-radius-sm)] px-2 py-1.5 text-sm outline-none",
        "transition-colors duration-[120ms]",
        // Highlight (Radix sets data-highlighted on focus + hover)
        "data-[highlighted]:bg-[var(--ds-dropdown-menu-action-secondary-hover)]",
        "data-[highlighted]:text-[var(--ds-dropdown-menu-text-default)]",
        // Destructive variant: critical-toned text + hover surface
        "data-[variant=destructive]:text-[var(--ds-dropdown-menu-text-on-action-critical)]",
        "data-[variant=destructive]:data-[highlighted]:bg-[var(--ds-dropdown-menu-action-critical)]",
        // Disabled
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset || undefined}
      className={cn(
        "px-2 py-1.5 text-xs font-medium text-[var(--ds-dropdown-menu-text-subtle)]",
        "data-[inset]:pl-8",
        className
      )}
      {...props}
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn(
        "-mx-1 my-1 h-px bg-[var(--ds-dropdown-menu-border-subtle)]",
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-[var(--ds-dropdown-menu-text-subtle)]",
        className
      )}
      {...props}
    />
