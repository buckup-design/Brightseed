...
interface BadgeProps {
  children: ReactNode;
  variant?: "filter" | "neutral" | "ghost" | "regulatory" | "outline";
...
const variantStyles: Record<NonNullable<BadgeProps["variant"]>, string> = {
  ...
  // Bordered, white fill — same treatment as NaturalSourceCard's predicted-
  // compound count badge (a bordered, no-fill look distinct from neutral's
  // solid grey).
