...
| Codename | What it is |
|---|---|
| **Hummingbird** | Brightseed's biotech compound-screening application: the product UI this project designs for. Conversational AI thread on the left, structured result surfaces on the right. Currently alpha (3 customer POCs, <10 by EOY 2026). |
| **Forager** | The AI discovery model that powers Hummingbird. Surfaces strategies, compounds, and plant sources from Brightseed's proprietary dataset, with evidence, feasibility, and IP/legal signals. Not the UI; the engine under it. |
...
| **Tag colors** | The 8 decorative hues for tag-dense Hummingbird surfaces (forest, lime, cyan, blue, yellow, orange, lavender, orchid). Color does NOT imply status, for status meaning, compose icon + text. |
...
| POC | Proof Of Concept | Hummingbird's customer engagement tier (3 today) |
| GLP-1 | Class of weight-loss drugs | Hummingbird use-case example |
| GRAS | Generally Recognized As Safe | FDA term, common in Hummingbird UI |
